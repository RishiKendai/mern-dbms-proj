...
import addQuestion from './JSFile/Operations/addQuiz';

export default function CreateQuiz() {
  const [isOn, setIsOn] = useState(false);
  // const [isQuestionAdded, setQuestionAdded] = useState({
  ...
  async function handleAdd() {
    ...
    if (newObj.stateValue) {
      ...
      const isCreated = await addQuestion(
        question,
        option1,
        option2,
        option3,
      ...
      <section className="quiz-div px-3">
        ...
        <div className="btn-div mt-3 d-flex">
          ...
          <button
            onClick={handleAdd}
            type="button "
            className="col btn btn-primary me-3 mb-3 p-2"
          >
